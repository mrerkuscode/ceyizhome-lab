...
OUTPUT_DIR = PROJECT_ROOT / "output" / "2026-05-21" / "production_queue_row_design_phase5"
RESULT_PATH = OUTPUT_DIR / "production_queue_row_design_phase5_gate_result.json"
