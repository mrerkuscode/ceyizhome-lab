...
def _order_from_v2_package(package: dict[str, Any], items: list[dict[str, Any]], v1_order: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "ship_deadline_ms": int(
            v1_order.get("agreedDeliveryDate")
            or package.get("agreedDeliveryDate")
            or 0
        ),
        "lines": lines,
    ...
    row.update(
        {
            ...
            "ship_deadline_ms": int(line.get("ship_deadline_ms") or row.get("ship_deadline_ms") or 0),
            "updated_at": _now(),
        }
    )
...
def _suggestion_from_line(line: dict[str, Any], mapping: dict[str, Any] | None, extracted: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "ship_deadline_ms": int(line.get("ship_deadline_ms") or 0),
